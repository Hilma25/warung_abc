...
<html>
    ...
    <body>
        ...
        <table border="1" cellpadding="6">
            <tr><th>No. Transaksi</th><th>Waktu</th><th>Kasir</th><th>Total Bayar</th></tr>
            ...
            <?php } ?>
            <tr><td colspan="3">Total Pendapatan Hari Ini</td>
                <td><?php echo number_format($total_harian, 0, ',', '.'); ?></td></tr>
        </table>
